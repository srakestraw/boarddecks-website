...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Testimonials Section - Conditional based on audience */}
      {selectedAudience === 'firm' && (
        <section className="py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary text-center mb-12">
              What Portfolio Managers Say
            </h2>
            
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                <div className="flex items-center mb-4">
                  <div className="w-12 h-12 bg-[#6C2BD9] rounded-full flex items-center justify-center mr-4">
                    <span className="text-white font-bold text-lg">JD</span>
                  </div>
                  <div>
                    <h4 className="font-semibold text-darkNavy">John Davis</h4>
                    <p className="text-sm text-gray-600">Managing Partner, Tech Ventures</p>
                  </div>
                </div>
                <p className="text-darkNavy leading-relaxed italic">
                  "Board Decks has transformed how we monitor our portfolio. We now have real-time visibility across all 25 companies, and our board meetings are infinitely more productive."
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-darkNavy">Sarah Mitchell</h4>
                    <p className="text-sm text-gray-600">Portfolio Director, Growth Capital</p>
                  </div>
                </div>
                <p className="text-darkNavy leading-relaxed italic">
                  "The standardized reporting has eliminated 80% of our manual data work. Our portfolio companies love the consistency, and we get better insights faster."
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-darkNavy">Michael Lee</h4>
                    <p className="text-sm text-gray-600">CEO, CloudScale Inc.</p>
                  </div>
                </div>
                <p className="text-darkNavy leading-relaxed italic">
                  "Board Decks has saved our team 15 hours per month on board prep. The automated data sync and professional templates have made our board meetings much more effective."
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-darkNavy">Alex Johnson</h4>
                    <p className="text-sm text-gray-600">Founder, DataFlow Solutions</p>
                  </div>
                </div>
                <p className="text-darkNavy leading-relaxed italic">
                  "Our board is impressed with the data quality and presentation. The ML validation gives us confidence in our forecasts, and our investors appreciate the transparency."
                </p>
              </div>
            </div>
          </div>
